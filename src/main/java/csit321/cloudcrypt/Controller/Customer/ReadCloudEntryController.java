...
public class ReadCloudEntryController {
    ...
    @Autowired
    public ReadCloudEntryController(CloudService cloudService,
    ...
    @PostMapping(path = "/ReadCloudEntry")
    public ResponseEntity<String> readCloudEntry(@RequestBody String json) {
        try {
            ...
            String cloudEntry = cloudService.readCloud(param);
