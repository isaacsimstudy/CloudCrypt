...
public class UpdateCloudEntryController {
    ...
    @Autowired
    public UpdateCloudEntryController(CloudService cloudService,
    ...
    @PostMapping(path = "/UpdateCloudEntry")
    public ResponseEntity<String> updateCloudEntry(@RequestBody String json) {
        try {
            ...
            String cloudEntry = cloudService.updateCloud(param);
