...
public class UpdateEmailQueueController {
    ...
    @Autowired
    public UpdateEmailQueueController(EmailQueueServiceImpl emailQueueServiceImpl,
    ...
    public ResponseEntity<String> updateEmailQueue(@RequestBody String json) {
        try {
            ...
            String result = emailQueueServiceImpl.updateEmailQueue(userAccount.getId(), updates);
